    ...
    <section className="max-w-3xl animate-in fade-in-50 duration-200">
      ...
      <div className="space-y-4">
        <h3 className="flex items-center gap-2 text-sm font-semibold text-foreground">
          ...
          {t("settings.appearance.modeHeading")}
        </h3>

        <div
          role="radiogroup"
          aria-label={t("settings.appearance.colorModeAria")}
      ...
      <div className="mt-8 space-y-4">
        <h3 className="flex items-center gap-2 text-sm font-semibold text-foreground">
          ...
          {t("settings.appearance.accentHeading")}
        </h3>
...
function ModeCard({
  ...
  const modeLabel = t(isLight ? "settings.appearance.modeLight" : "settings.appearance.modeDark");
  return (
    <button
      type="button"
      role="radio"
      ...
      aria-label={t("settings.appearance.useModeAria", { mode: modeLabel })}
      className={cn(
...
function ThemeCard({
  ...
  return (
    <button
      ...
      aria-label={t("settings.appearance.useThemeAria", { name })}
      className={cn(
    ...
    >
      ...
      <span className="sr-only">{t("settings.appearance.themeIdLabel", { id })}</span>
    </button>
  );
}
